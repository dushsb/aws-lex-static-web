...
const aws_bots_config = '[{"name":"LibertyChatBot","alias":"prod","description":"Bot to order flowers.","bot-template":"bot-flowers","commands-help":["I would like to pick up flowers","I would like to order some flowers","Buy flowers"],"region":"us-east-1"}]';
const aws_cognito_identity_pool_id = 'us-east-1:8f22616d-57db-40dd-ac83-1a046ad20f72';
